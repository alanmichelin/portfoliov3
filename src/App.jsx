...
function App() {
  ...
  const executeScroll = (props) => {
    console.log(props);
    if (props === "Inicio" || props === "Home")
      return home.current.scrollIntoView();
    if (props === "Perfil" || props === "Profile")
      return profile.current.scrollIntoView();
    if (props === "Projects" || props === "Proyectos")
      return projects.current.scrollIntoView();
    if (props === "Curriculum" || props === "Resume") return handleOpen();
    if (props === "Contacto" || props === "Contact")
    ...
    <div>
      ...
      <Grid container ref={projects} spacing={2}>
        ...
        <Grid item xs={12} lg={9}>
          <h3 style={{ fontFamily: "Montserrat", fontSize: "7vh" }}>
            {data.general.Buttons[2]}
          </h3>
        ...
        <Grid item xl={12} sm={12} style={{ marginLeft: "15px" }}></Grid>
      </Grid>
      <div ref={contact}>
